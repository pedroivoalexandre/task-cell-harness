...
class GeminiExecutor(BaseExecutor):
    ...
    def __init__(self, config=None, artifact_root="artifacts"):
        self.config = config or {"command": "gemini", "enabled": False}
        self.role = self.config.get("role", "gemini")
    ...
    def execute(self, task, context):
        ...
        prompt = self.prompt_builder.build_gemini_prompt(
            task,
        ...
        return {
            ...
            "output": "Gemini dry-run prepared prompt.",
